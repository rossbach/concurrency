...
// file:	PLINQKMeans.cs
//
// summary:	Implements the kmeans using parallel linq
///-------------------------------------------------------------------------------------------------
...
namespace KMeans
{
    class PLINQKMeans : KMeansCalculator
    {
        protected KMeansOptions m_options = null;
        public PLINQKMeans(KMeansOptions options) { m_options = options; }
        ...
        public static ParallelQuery<Vector> 
        Step(
